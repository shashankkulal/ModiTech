<script type="text/javascript">
		var interval;
		var formData = {email:"<?php echo $_SESSION['email']; ?>"}; 
		function checkAlive()
		{
			$.ajax({
				type: "POST",
				url: "apps/ajax/checkAlive.php",
				data: formData,
				success: function(data) 
				{
					interval = setTimeout(checkAlive, 30000);
				}
			});
		}
		checkAlive();
	...
	<div class="navbar navbar-inverse">
		...
		<div class="navbar-collapse collapse" id="navbar-mobile">
			...
			<p class="navbar-text">
				<span class="label bg-success">BETA</span>
			</p>
				...
				<ul class="nav navbar-nav">
					...
					<li class="dropdown dropdown-user">
						...
						<ul class="dropdown-menu dropdown-menu-right">
							...
							<li><a href="messages.php"><span class="badge bg-blue pull-right">58</span> <i class="icon-comment-discussion"></i> Messages</a></li>
							<li class="divider"></li>
