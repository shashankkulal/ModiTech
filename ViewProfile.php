<?php
	...
	if(!isset($_GET['id'])) $viewId = $loginUser['appkey'];
	else $viewId = $_GET['id'];
	if(!$obj->validateProfileId($viewId)) 
	{
		echo "Not Verified";
	}
					...
					<div class="navbar navbar-default navbar-component navbar-xs">
						...
						<div class="navbar-collapse collapse" id="navbar-filter">
							<ul class="nav navbar-nav">
								...
								<li class=""><a href="#schedule" data-toggle="tab" aria-expanded="false"><i class="icon-calendar3 position-left"></i> Schedule <span class="badge badge-success badge-inline position-right">32</span></a></li>
								<li class=""><a href="#settings" data-toggle="tab" aria-expanded="false"><i class="icon-cog3 position-left"></i> Settings</a></li>
							</ul>
													...
													<div class="row">
														...
														<div class="col-lg-6">
															<div class="panel panel-flat timeline-content">
																...
																<div class="panel-body">
																	<div class="video-container content-group">
																		<iframe allowfullscreen="" frameborder="0" mozallowfullscreen="" src="https://player.vimeo.com/video/133217402?title=0&amp;byline=0&amp;portrait=0" webkitallowfullscreen="" __idm_frm__="26"></iframe>
														            </div>
